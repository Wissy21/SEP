...
import static main.gui.GuiHelper.showErrorOrWarningAlert;
...
public class RegistrierenController {
    ...
    public void registrieren(ActionEvent actionEvent) {
        ...
        try {
            ...
            if(check){
                showErrorOrWarningAlert(Alert.AlertType.INFORMATION, "Erfolgreiche Registrierung", "Benutzer erfolgreich registriert", "Sie haben sich registriert!");
