...
public class VueManager {
    ...
    public static void goToLogIn(Event event, String serverIp) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/anmelden.fxml"));
    ...
    public static void goToRegister(Event event, String serverIp) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/registrieren.fxml"));
        Parent root = loader.load();
    ...
    public static void goToMenue(Event event, String name, String serverIp) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/spielmenue.fxml"));
        Parent root = loader.load();
    ...
    public static void datenAendern(Event event, String name, String ip) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/dateiAendern.fxml"));
        Parent root = loader.load();
    ...
    public static void goToBestenliste(Event event, String n, String ip) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/bestenListe.fxml"));
        Parent root = loader.load();
    ...
    public static void goToSpielraum(Event event, String n, String raumname,String ip) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/spielraum.fxml"));
        Parent root = loader.load();
    ...
    public static void goToStartFenster(Event event, String ip) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/startfenster.fxml"));
        Parent root = loader.load();
    ...
    public static void goToLobby(Event event, String n, String ip) throws IOException {
        FXMLLoader loader = new FXMLLoader(SpielenClient.class.getResource("gui/vue/lobby.fxml"));
        Parent root = loader.load();
