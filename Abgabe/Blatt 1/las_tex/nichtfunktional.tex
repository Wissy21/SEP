...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:alter}
		...
		\item [Motivation:] Jüngere Benutzer sind noch unfähig das Spiel zu spielen.
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:umgebung}
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:versionierung}
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:unterstü}
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:kompa}
		\item [Name:] Kompatibilität
		\item [Beschreibung:] Siehe \ref{nfunk:sarch2}
		\item [Motivation:] Möglichst breites Spektrum an Nutzern abdecken.
		\item [Erfüllungskriterium:] Siehe \ref{nfunk:sarch2}
	\end{lhp}
\end{description}
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:integrität}
		\item [Name:] Regelwerk
		...
		\item [Erfüllungskriterium:] Einhalten der Regeln
	\end{lhp}
\end{description}
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:datenschutz}
		...
		\item [Erfüllungskriterium:] Sieher Beschreibung
	\end{lhp}
\end{description}
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:virenschutz}
		...
		\item [Beschreibung:] Es sind keine Viren in der Software enthalten.
		\item [Motivation:] Keine illegalen Aktivitäten geduldet.
		\item [Erfüllungskriterium:] Virenfreie Software
	\end{lhp}
\end{description}
...
\begin{description}[leftmargin=5em, style=sameline]	
	\begin{lhp}{nf}{NF}{nfunk:beispiel12}
		...
		\item [Erfüllungskriterium:] Jeder der Deutsch sprechen kann kann das Spiel spielen.
	\end{lhp}
\end{description}
